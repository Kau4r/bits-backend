...
router.get('/april-25-demo-preview', authenticateToken, authorize('ADMIN'), asyncHandler(getApril25DemoCleanupPreview));
...
router.post('/april-25-demo-cleanup', authenticateToken, authorize('ADMIN'), asyncHandler(runApril25DemoCleanup));
